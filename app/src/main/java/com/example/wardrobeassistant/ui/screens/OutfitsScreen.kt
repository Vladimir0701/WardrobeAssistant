...
fun OutfitsScreen(
    ...
    Column(
        ...
        // показываем только когда есть полноценный комплект (база + низ)
        // если что то одно пусто - смысла нет, юзер пусть сначала заполнит
        if (slotBase != null && slotBottom != null) {
